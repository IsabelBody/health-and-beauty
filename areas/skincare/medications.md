...
Confirm dose and timing with your prescriber. Not medical advice.
...
| Supplement | Brand / dose | Started | Status |
|------------|--------------|---------|--------|
| Vitamin D | — | — | Taking **inconsistently** |
| Iron bisglycinate | — | — | **Will start** |
| Vitamin C | — | — | **Will start** |
| Magnesium | — | — | **Will start** |
| B12 | — | — | **Will start** |

**Timing (planned):** separate iron from calcium/magnesium/zinc by ~2 h where possible; vitamin C often paired with iron — confirm spacing when brands/doses are filled in.

## TODO

- [ ] Add **brands and specific doses** for all supplements (including vitamin D)
- [ ] Add an **update on consistency** (vitamin D baseline + how the new stack is going once started)
